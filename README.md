...
!\[Before Forward](images/Bf\_Frd1.png)

!\[Before Forward](images/Bf\_Frd2.png)

!\[Before Forward](images/Bf\_Frd3.png)
...
!\[After Forward](images/Af\_Frd1.png)

!\[After Forward](images/Af\_Frd2.png)

!\[After Forward](images/Af\_Frd3.png)
...
!\[Before stall](images/Bf\_Stall.png)
...
!\[After stall](images/Af\_Stall.png)
...
!\[Before ctrl hazard](images/Bf\_Ctrl\_Haz1.png)

!\[Before ctrl hazard](images/Bf\_Ctrl\_Haz2.png)

!\[Before ctrl hazard](images/Bf\_Ctrl\_Haz3.png)
...
!\[After ctrl hazard](images/Af\_Ctrl\_Haz1.png)

!\[After ctrl hazard](images/Af\_Ctrl\_Haz2.png)

!\[After ctrl hazard](images/Af\_Ctrl\_Haz3.png)



*\*\*Observation:\*\**  

*The waveforms show `PCSrc\_out` going high, immediately triggering `FlushD` and `FlushE`. The instructions in the pipeline are replaced by NOPs (`00000013`).*
...
| StallF/D | lw\_dependency | Holds the instruction stream to allow memory loads to complete. |

| FlushD | BranchTaken | Clears the Decode stage to prevent "wrong path" execution. |

| FlushE | lw\_dependency OR BranchTaken | Clears the Execute stage to inject a NOP/Bubble. |
...
!\[Final Hazard-Aware Architecture](images/hazard\_architecture\_diagram.png)
...
\[Finalwaveform](images/Final\_wf1.png)

\[Finalwaveform](images/Final\_wf2.png)

\[Finalwaveform](images/Final\_wf3.png)
